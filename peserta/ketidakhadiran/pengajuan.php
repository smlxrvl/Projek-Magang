...
if(isset($_POST['submit'])) {
    ...
    if(isset($_FILES['keterangan'])) {
        $file = $_FILES['keterangan'];
        $nama_file = $file['name'];
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if(!empty($pesan_kesalahan)) {
            ...
            $result = mysqli_query($connection, "INSERT INTO ketidakhadiran(id_peserta, keterangan, tanggal, deskripsi, surat, status) 
            VALUES ('$id', '$keterangan', '$tanggal', '$deskripsi', '$nama_file', '$status')");
                             
            $_SESSION['berhasil'] = "Data ketidakhadiran berhasil ditambahkan.";
...
$id = $_SESSION['id'];
$result = mysqli_query($connection, "SELECT * FROM ketidakhadiran WHERE id_peserta = '$id' ORDER BY id DESC")
?>
