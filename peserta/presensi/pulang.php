    ...
    <?php } else { ?>
                    ...
                    <div class="col-md-6">
                        <div class="card text-center">
                            <div class="card-body" style="margin: auto;">
                                ...
                                <div class='text-black-50'><?= date('d/m/Y', strtotime($tanggal_pulang)) . " - " . $jam_pulang?></div>
                                <button id="ambil-foto"class="btn btn-info bg-danger mt-2">Pulang</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <script language="JavaScript">
            ...
            document.getElementById('ambil-foto').addEventListener('click', function() {
                ...
                console.log('Debug: id=' + id + ', tanggal=' + tanggal_pulang + ', jam=' + jam_pulang);
                ...
                Webcam.snap(function(data_uri) {
                    ...
                    xhttp.open("POST", "pulang_action.php", true);
